...
<section id="logGrid">
    <div class="logLeft">
        ...
        <div  id="signUp" class="logWrap">
            <!-- <form class="animate" action="RegisterServlet" method="post" id="RegisterServlet">
              ...
              <div class="logPop">
                ...
                <br><br>
                <button class="white" type="submit">Next</button>
                <a onclick="showPop()">Sign in instead</a>
              </div>
            </form> -->
        </div>
    ...
    <div class="logRight">
        ...
        <div class="logBox">
            <!-- <h2>Join us today.</h2> -->
            <!-- <button onclick="showPop2()" class="white">
              Sign Up
            </button> -->
